	...
	public class Dungeon : MonoBehaviour
	{
		...
		public void FromProxy(DungeonProxy proxyDungeon, DungeonGenerator generator)
		{
			...
			foreach (ProxyDoorwayConnection connection in proxyDungeon.Connections)
			{
				...
				Doorway doorway5 = (doorway4.ConnectedDoorway = tile2.AllDoorways[connection.B.Index]);
				doorway5.ConnectedDoorway = doorway4;
				DoorwayConnection item = new DoorwayConnection(doorway4, doorway5);
				connections.Add(item);
				SpawnDoorPrefab(doorway4, doorway5, generator.RandomStream);
			}
		}
