/// <summary>
/// PlayerInput đóng vai trò là "Cổng tiếp nhận thông tin" từ thiết bị ngoại vi (Bàn phím, Chuột).
/// 
/// Tác dụng:
/// - Thu thập tín hiệu từ phần cứng và đóng gói lại thành dữ liệu mạng (NetworkInput) để gửi lên Server.
/// - Làm mượt chuyển động chuột (Look Sensitivity), giúp quay camera không bị giật lag.
/// - Đồng bộ thao tác bấm giữa máy bạn và Server (đảm bảo Server biết bạn bấm nút Nhảy đúng lúc nào).
/// 
/// Nếu thiếu script này:
/// - Game bị "cắt đứt liên lạc" với người chơi: Bạn bấm nát bàn phím, di chuột gãy tay thì nhân vật vẫn đứng trơ ra.
/// - PlayerMovement không nhận được lệnh điều khiển nào cả.
/// - Game trở thành... phim hoạt hình tĩnh vì không ai điều khiển được gì hết.
/// </summary>
